...
// Pointing to your deployed backend or dev env
const API_URL = import.meta.env.VITE_API_URL ? `${import.meta.env.VITE_API_URL}/products` : "https://e-commerce-a2ab.onrender.com/api/products";
